...
const char *password = "0975402552";
...
void buildWeb(){
  ...
  webSite+="</script>";
  webSite += "<style>";
  webSite += "body{background-color:#73C4B2; font-family: Arial, Helvetica, Sans-Serif; Color: #508F82;}";
  ...
  webSite += "<p>Rotate Angle：<span id = \"red-text\">0</span></p>";
  webSite += "<input type=\"range\" id=\"red\" name=\"R-led\" min=\"0\" max=\"360\" value=\"0\">";
